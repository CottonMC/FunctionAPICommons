...
class StaticCommandExecutor() : CommandExecutor {
    ...
    override val commandDispatcher = CommandDispatcher<MutableMap<String, Any>>()
    ...
    fun registerDataObject(obj: CommandData) {
    ...
    override fun execute(identifier: FunctionAPIIdentifier, source: MutableMap<String, Any>) {
        if (!executed) {
            executed = true
        }
    ...
    fun execute(command: String, source: MutableMap<String, Any>) {
    ...
    fun printDocs( writer: Writer) {
        ...
        val contentRegistrationContext: MutableMap<String, Any> = HashMap()
