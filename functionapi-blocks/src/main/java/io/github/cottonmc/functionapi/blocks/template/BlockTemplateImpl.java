package io.github.cottonmc.functionapi.blocks.template;

import io.github.cottonmc.functionapi.api.content.BlockTemplate;
import io.github.cottonmc.functionapi.api.content.CollosonShape;
...
public class BlockTemplateImpl implements BlockTemplate {
    ...
    @Override
    public void addCollosionShape(String name, String value, CollosonShape collosonShape) {
